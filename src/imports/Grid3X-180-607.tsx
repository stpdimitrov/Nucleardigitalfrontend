import svgPaths from "./svg-6c55uigcmm";
import imgImage from "figma:asset/e55f19621fc993b2cbf97f430d52ffb48c20a89a.png";
import { imgDiv } from "./svg-ta7os";
...
export default function Grid3X() {
  return (
    <div className="content-stretch flex gap-[20px] items-start justify-center relative size-full" data-name="Grid 3x">
      <ContactLinksCard />
      <SocialLinksCard />
      <OfficeCard />
    </div>
