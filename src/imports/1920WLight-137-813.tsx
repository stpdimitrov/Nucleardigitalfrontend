import svgPaths from "./svg-y9fs8xy94d";
...
import { imgBottom, imgBgBlur, imgBgBlur1, imgIframeFramerEditorbar } from "./svg-vjbp9";
  ...
  return (
    <div className="h-[10px] relative shrink-0 w-[97px]" data-name="Component 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97 10">
        <g clipPath="url(#clip0_137_840)" id="Component 1">
          <path d={svgPaths.p29f9900} fill="var(--fill-0, black)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_137_840">
...
function H4FramerText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="h4.framer-text">
      <a className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-white tracking-[-0.72px] w-full" href="https://primary-words-404174.framer.app/projects/lumen-brew">
        <p className="cursor-pointer leading-[50.4px] text-[34.3px] whitespace-pre-wrap">Lumen Brew</p>
      </a>
    </div>
  );
}
...
function PFramerText2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <a className="cursor-pointer flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[24px] not-italic relative shrink-0 text-[#ddd] text-[0px] text-[14.4px] tracking-[-0.32px] w-full whitespace-pre-wrap" href="https://primary-words-404174.framer.app/projects/lumen-brew">
...
function PFramerText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="p.framer-text">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ddd] text-[12.1px] whitespace-nowrap">
...
function FeaturedProject() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px overflow-clip relative w-full" data-name="Featured project">
      <Video />
      <BgBlurMaskGroup />
      <TextWrapper1 />
    </div>
...
function KiZgWzIdjAcGt6GFw3CmPhgS9EsMp() {
  return <div className="flex-[1_0_0] min-h-px min-w-px w-full" data-name="KiZGWzIDJAcGT6gFW3CMPhgS9Es.mp4" />;
}
